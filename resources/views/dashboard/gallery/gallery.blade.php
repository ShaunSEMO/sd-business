            ...
            <div class="card">
                <h5 class="card-header">
                    ...
                    <div class="btn-group" role="group" aria-label="Basic example">
                        ...
                        {!! Form::open(['action' => ['DashboardController@deleteGallery', $event->id], 'method' => 'POST']) !!}
                            {{ Form::hidden('_method', 'DELETE') }}
                            {{ Form::submit('Delete', ['class' => 'btn btn-danger'])}}
                        {!!Form::close()!!} 
                    </div>
                    <br>
                    {!! Form::open(['action' => ['DashboardController@updateGalleryName', $event->id], 'files' => true, 'method' => 'post', 'enctype' => 'multipart/form-data', 'class'=>'hidden hidden-form-3']) !!}
